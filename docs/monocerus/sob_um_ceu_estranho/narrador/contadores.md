...
## Consequências e Marcadores

Para Contadores que são preenchidos apenas com Marcadores, cada nível de consequência é convertido numa certa quantidade de Marcadores segundo a tabela abaixo:

| Nível     | Marcadores   |
|-----------|--------------|
| Dramático | Preencha XXX |
| Intenso   | Preencha XX  |
| Moderado  | Preencha X   |
| Limitado  | Preencha /   |
...
Contadores de condição acompanham a situação de um indivíduo ou desafio. Contadores de situação são preenchidos de acordo com as consequências sofridas pela entidade que é representada pelo contador.

Contadores de situação são preenchidos de forma não sequencial. Cada condição deve ser preenchida no nível correspondente à sua gravidade, se não houver mais espaço no nível correspondente, a condição é preenchida no nível disponível acima dela.

### Contadores de Condição Simples

No caso de Contadores simples, o preenchimento é realizado apenas usando Marcadores, sem nenhum descritivo especifico. 
...
### Contadores de Condição Descritivos

O mais comum dos contadores de condição é aquele que acompanha a situação dos personagens dos jogadores. Nesse caso, cada condição possue uma descrição narrativa que a define.
...
Contadores de eventos são preenchidos de acordo com o sucesso ou fracasso do grupo de personagens  em alcançar certos marcos da história. Todos os contadores de eventos têm gatilhos associados a seus níveis. Contadores de eventos são preenchidos com Marcadores.
